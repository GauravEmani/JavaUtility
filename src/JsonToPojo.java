...
public class JsonToPojo {
	...
	public static void main(String[] args) {
		String output = "<ciudads><ciudad><idCiudad>1</idCiudad><nomCiudad>BOGOTA</nomCiudad></ciudad><ciudad><idCiudad>6</idCiudad><nomCiudad>Pereira</nomCiudad></ciudads>";
		
		String packageName="com.cooltrickshome";
		File inputJson= new File("."+File.separator+"input3.json");
